    ...
    addRequestToLog(obj) {
        ...
        if (this.scope && this.scope.request_id) {
            if (typeof _obj === 'object') {
                ...
                // resolvendo o Bug que fazia o assign ficar nulo
                // por algum motivo objetos do tipo Error não aceitam
                // destructuring
                if (_obj instanceof Error) {
                ...
                _obj = Object.assign({}, { _obj, natural: { request_id: this.scope.request_id } });
            } else {
                _obj = Object.assign({}, { natural: { request_id: this.scope.request_id } });
            }
        }
